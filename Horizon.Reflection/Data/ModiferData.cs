...
namespace Horizon.Reflection
{
    ...
    public abstract class ModifierData : MemberData
    {
        ...
        /// <summary>
        /// Does the left hand side <see cref="ModifierData"/> contain any of the set bits from the specified right hand side <see cref="ModifierData"/>?
        /// </summary>
        /// <param name="lhs">Left hand side <see cref="ModifierData"/>.</param>
        /// <param name="rhs">Right hand side <see cref="ModifierData"/>.</param>
        /// <returns>True if the specified left hand side <see cref="ModifierData"/> contains any of the set bits in the specified right hand side <see cref="ModifierData"/>; otherwise, false.</returns>
        ...
        /// <summary>
        /// Does the left hand side <see cref="ModifierData"/> contain all of the set bits from the specified right hand side <see cref="ModifierData"/>?
        /// </summary>
        /// <param name="lhs">Left hand side <see cref="ModifierData"/>.</param>
        /// <param name="rhs">Right hand side <see cref="ModifierData"/>.</param>
        /// <returns>True if the specified left hand side <see cref="ModifierData"/> contains all of the set bits in the specified right hand side <see cref="ModifierData"/>; otherwise, false.</returns>
        public static bool operator &(ModifierData lhs, ModifierFlags rhs)
        {
            return lhs != null && lhs._modifierFlags & rhs;
        }
